...
int main(int argc, char *argv[])
{
  ...
  short int table_flag=0,limbo_flag=0,list_limbo=0,row_flag=0,caption_flag=0,steplist_flag=0,sli_flag=0,title_flag=0,li_flag=0,entry_flag=0,tp_flag=0,list_change_flag=0,p_flag=0,list_protect_flag=0,input_flag=0;
