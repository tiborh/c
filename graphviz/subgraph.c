...
Agedge_t** connect_graph(Agraph_t *g,Agnode_t **nodes, char prefix)
{
...
int main(int argc, char **argv)
{
  ...
  Agnode_t** subnodes = fillgraph(subg);
  Agedge_t** subedges = connect_graph(subg,subnodes);
